...
import (
	...
	"github.com/bmuna/CoinPay/backend/crypto_eth"
...
func main() {
	...
	crypto_eth.SendETH(client, privateKey, fromAddress, toAddress, amount)
	...
	tokenBalance, err := crypto_eth.GetERC20Balance(client, usdtAddress, fromAddress.Hex())
	if err != nil {
